...
<div class="constitution">
    <h1 class="noUnderscore">The ORIGINAL FA Dynasty Fantasy Football Dynasty Bylaws</h1>
    ...
    <p>15 Bench (Expanded by 5 between the keague draft and start of regular season)</p>

    <p>3 IR Spots (Player must be labeled as IR, Out, or Covid in the Sleeper App)</p>

    <p>3 Taxi Spots (Player must be Rookie)</p>
    ...
    <div class="subBlock">
        <p>There is will be zero tolerance for anyone Lending Players to impact the outcome of a game.</p>
    </div>
    
    <h4 bind:this={oneTwoThree}>1.2.3 Trade Deadline</h4>
    <div class="subBlock">
        <p>There will be NO Trade Deadline. You may trade throughout the Playoffs</p>
    </div>
    
    <h4 bind:this={oneTwoFour}>1.2.4 Trade Restrictions</h4>
    <div class="subBlock">
        <p>You may only trade Draft Picks for Seasons you have paid for. You may make a trade and immediately pay for that seasons pick. ie. Trading a 2024 1st Round pick requires you to pay for the 2024 Season at the time of the trade. </p>
    </div>    
    
    <h3 bind:this={oneThree}>1.3 Waiver Wire</h3>
    
    <p>FAAB Waiver wire system. Each team will begin the season with $100 distributed twice. At the start of the offseason and again at the start of the Regular Season. Waivers will process every day at 12pm EST. $0 bids are allowed.</p>
    ...
    <p>Rookie drafts will consist of 4 round of drafting, with 4 hours alotted for each pick. The Draft timer will pause from 11pm EST to 10am EST.</p>
    ...
    <ol>
        ...
        <li>Coin Flip</li>
        <li>WWE Steel Cage Match</li>
    </ol>

    <h2 class="sectionHeading" bind:this={five}>Section 5 Tanking Policy</h2>
    
    <h3 bind:this={fiveOne}>5.1 League Tanking Policy</h3>
    <p>No team may intentionally leave starting roster spots empty. Any evidence of intentionally leaving roster spots empty in order to improve your draft position may be subject to punishment, including but not limited to the removal of the league.</p>
    ...
    <p>When a manager needs to be replaced, the comissioners will try to find a suitable candidate with some connection to at least a portion of the existing managers. Priority will be placed on managers who are eager to take on a dynasty commitment and will be very active within the league. A list of members will be kept and go in order of when they announced their interest in joining</p>

    <h2 class="sectionHeading" bind:this={seven}>Section 7 League Finances</h2>
    
    <h3 bind:this={sevenOne}>7.1 League Dues</h3>
    <p>League dues are set at $20. Dues are collected through LeagueSafe and collection will be sent out no later than the start of the Rookie Draft. All managers must be fully paid up before the start of the Draft.</p>
